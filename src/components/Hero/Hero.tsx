...
export default function Hero() {
  ...
  return (
    <div className={`container-hero ${state.darkmode ? "dark-bg-1" : "light-bg-1"}`}>
      ...
      >
        {state.language === "english" ? "Young and caffeinated student developer, juggling code and creativity with a side of curiosity:) " : "Young and caffeinated student developer, juggling code and creativity with a side of curiosity:) "}
      </motion.h4>
